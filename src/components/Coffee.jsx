...
const Coffee = ({ coffee, loadedCoffees, setLoadedCoffees }) => {
  ...
  return (
    <div className="card lg:card-side bg-[#f4f3f0] shadow-xl">
      <figure>
      ...
      <div className="flex w-full m-4 items-center justify-between">
        ...
        <div className="card-actions justify-end join join-vertical">
          <button className="btn join-item bg-[#e7bd49]">View</button>
          <Link to={`/updateCoffee/${_id}`}>
            <button className="btn join-item px-5 btn-neutral">Edit</button>
          </Link>
          <button
